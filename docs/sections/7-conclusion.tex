...
de Shannon em diferentes escalas. Como referência contemporânea, foram
incluídos baselines de aprendizado profundo no sensor Sentinel-2, sob o mesmo
protocolo de métricas calculadas estritamente em pixels ausentes.
...
temporais quando séries estejam disponíveis; e (iii) investigar estratégias de
treinamento e seleção de modelos de \gls{DL} que utilizem entropia como sinal
auxiliar, respeitando dependência de escala e variações entre sensores.
