...
\begin{itemize}
  ...
  \item \textbf{H3.} Para cada janela de entropia analisada separadamente, a entropia é um preditor estatisticamente significativo das métricas de qualidade, controlando por método e por ruído.
\end{itemize}
