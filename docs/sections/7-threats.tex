...
\gls{PSNR}, \gls{SSIM}, \gls{RMSE}, \gls{SAM} e \gls{ERGAS} capturam aspectos centrais da reconstrução, mas não são equivalentes a utilidade em tarefa final.
...
As arquiteturas foram treinadas e avaliadas em domínio Sentinel-2, de modo que as conclusões sobre U-Net, \gls{GAN}, \gls{ViT}, \gls{AE} e \gls{VAE} devem ser entendidas como válidas para esse contexto experimental específico.
