...
Ordinary Kriging, RBF e Thin Plate Spline aparecem repetidamente entre os métodos de melhor qualidade, mas não ocupam a mesma posição quando o tempo de inferência entra explicitamente na análise.
