...
\title[Presenting the JISA template for 2023]{Presenting the JISA template for 2023}


\author[Viterbo et al. 2023]{
\affil{\textbf{José Viterbo}~\href{https://orcid.org/0000-0002-0339-6624}{\textcolor{orcidlogo}{\aiOrcid}}~\textcolor{blue}{\faEnvelopeO}~~[~\textbf{Universidade Federal Fluminense}~|\href{mailto:viterbo@ic.uff.br}{~\textbf{\textit{viterbo@ic.uff.br}}}~]}
...
\begin{abstract}
\textbf{Abstract}
\noindent Cloud cover, sensor malfunctions, and orbital repeat cycles
...
\begin{funding}
This research was funded by lorem ipsum dolor sit amet, consectetur adipiscing elit.
\end{funding}
...
\begin{interests}
The authors declare that they have the following competing interests, lorem ipsum dolor sit amet, consectetur adipiscing elit.
\end{interests}

\begin{materials}
The datasets generated and/or analysed during the current study are available in lorem ipsum dolor sit amet.
\end{materials}
